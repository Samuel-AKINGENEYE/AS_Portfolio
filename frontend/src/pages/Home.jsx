          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
              ...
              <ul className="space-y-3">
                ...
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="Next.js" size={18} /> Next.js</li>
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="TypeScript" size={18} /> TypeScript</li>
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="Tailwind CSS" size={18} /> Tailwind CSS</li>
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="HTML/CSS" size={18} /> HTML/CSS</li>
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="JavaScript" size={18} /> JavaScript</li>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
              ...
              <ul className="space-y-3">
                ...
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="Express" size={18} /> Express</li>
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="Python" size={18} /> Python</li>
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="Java" size={18} /> Java</li>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
              ...
              <ul className="space-y-3">
                ...
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="MongoDB" size={18} /> MongoDB</li>
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="Redis" size={18} /> Redis</li>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
              ...
              <ul className="space-y-3">
                ...
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="Docker" size={18} /> Docker</li>
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="AWS" size={18} /> AWS</li>
                <li className="text-slate-600 dark:text-slate-400 text-sm flex items-center gap-3"><SkillIcon name="Vercel" size={18} /> Vercel</li>
              </ul>
            </div>
          </div>
        </div>
