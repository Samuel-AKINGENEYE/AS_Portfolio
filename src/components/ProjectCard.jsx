      ...
      <div className="relative z-[2] flex flex-col flex-1 min-h-0 p-5">
        ...
        {project.problem && (
          <div className="mb-3">
            ...
            <p className="font-serif text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
              {project.problem}
            </p>
          </div>
        )}
        ...
        {project.solution && (
          <div className="mb-2">
            ...
            <p className="font-mono text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              {project.solution}
            </p>
          </div>
        )}
