  ...
  return (
    ...
    >
      ...
      <div className="relative z-[2] flex flex-col flex-1 min-h-0 p-5">
        ...
        <p className="text-sm font-light tracking-wide text-slate-400 dark:text-slate-500 leading-relaxed mb-4">
          {project.description}
        </p>
        ...
        {project.problem && (
          <div className="mb-3">
            ...
            <p className="text-sm font-semibold tracking-tight text-slate-700 dark:text-slate-300 leading-snug">
              {project.problem}
            </p>
          </div>
        )}
